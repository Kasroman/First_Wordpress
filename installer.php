...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'KasRoman_wp_treeTravel_7786dfb3a2187e7c1634_20220311111348_archive.zip';
	const ARCHIVE_SIZE		 = '39772877';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '7786dfb-11111348';
    const SECONDARY_PACKAGE_HASH = 'e04ecbe-11111348';
	const VERSION			 = '1.4.4';
